...
export function mountPacketGeometry({host,getGeometry,onCommit,pause,resume}){
 ...
 host.append(layer);const [detector,height,wall]=layer.querySelectorAll('button'),guide=layer.querySelector('div'),value=layer.querySelector('output');let drag=null;
 function update(){
