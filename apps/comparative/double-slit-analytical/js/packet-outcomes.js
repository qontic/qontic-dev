import {sourceCoefficients,sourceTransverse,sampleSource} from './source-packet-model.js?v=2.91';
...
export function detectorLaw(p,profile,ymin,ymax){
 ...
 let transmission=0;
 for(let j=0;j<=n;j++)transmission+=sourceTransverse(-bound+j*dx,p.wall,p,coeff).rho*(j===0||j===n?1:j%2?4:2)*dx/3;
