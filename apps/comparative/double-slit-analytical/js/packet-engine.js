import {physicsHTML,viewsHTML,physicsEquations,whichPathPhysicsHTML,whichPathViewsHTML,whichPathEquations} from './physics-content.js?v=2.103';
import {drawBinPulse,DETECTOR_PULSE_SECONDS} from './detector-pulse.js?v=59';
import {mountPacketGeometry,mountSlitWidth,mountSlitSeparation,trimTail,tailOpacity} from './packet-interaction.js?v=2.103';
import {histogramLayout,surfaceHeightValue,surfaceDisplayDensity,surfacePhaseRate} from './packet-model.js?v=2.103';
import {aperture,sourceCoefficients,sourceComponents,sourceTransverse,sourceEnvelope,sampleSource,sampleTransmittedSource,stepSource,sourceProfile,maximumCoreSafeSeparation} from './source-packet-model.js?v=2.103';
import {detectorLaw,quantumSchedule,recordWithHit,samplePixel} from './packet-outcomes.js?v=2.103';
export function mountPacketEngine({core,advanced}){
 ...
 async function ensureSurface3D(){
  ...
  if(!surface3DLoad)surface3DLoad=import('./packet-surface-3d.js?v=2.103').then(({mountPacketSurface3D})=>{
