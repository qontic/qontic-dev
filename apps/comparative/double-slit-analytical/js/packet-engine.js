import {physicsHTML,viewsHTML,physicsEquations} from './physics-content.js?v=2.86-truth';
import {drawBinPulse,DETECTOR_PULSE_SECONDS} from './detector-pulse.js?v=59';
import {mountPacketGeometry,mountSlitWidth,mountSlitSeparation,trimTail,tailOpacity} from './packet-interaction.js?v=2.86';
import {histogramLayout} from './packet-model.js?v=2.86';
import {aperture,sourceCoefficients,sourceTransverse,sourceEnvelope,sampleSource,sampleTransmittedSource,stepSource,sourceProfile} from './source-packet-model.js?v=2.86-truth';
import {detectorLaw,quantumSchedule,recordWithHit,samplePixel} from './packet-outcomes.js?v=2.86';
