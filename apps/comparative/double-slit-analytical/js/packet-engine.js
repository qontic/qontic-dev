import {physicsHTML,viewsHTML,physicsEquations} from './physics-content.js?v=81';
...
import {histogramLayout} from './packet-model.js?v=81';
import {aperture,sourceCoefficients,sourceTransverse,sourceEnvelope,sampleSource,sampleTransmittedSource,stepSource,sourceProfile} from './source-packet-model.js?v=81';
import {detectorLaw,quantumSchedule,recordWithHit,samplePixel} from './packet-outcomes.js?v=81';
