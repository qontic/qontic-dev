import {physicsHTML,viewsHTML,physicsEquations,whichPathPhysicsHTML,whichPathViewsHTML,whichPathEquations} from './physics-content.js?v=2.101';
import {drawBinPulse,DETECTOR_PULSE_SECONDS} from './detector-pulse.js?v=59';
import {mountPacketGeometry,mountSlitWidth,mountSlitSeparation,trimTail,tailOpacity} from './packet-interaction.js?v=2.101';
import {histogramLayout,surfaceHeightValue,surfacePhaseRate} from './packet-model.js?v=2.101';
import {aperture,sourceCoefficients,sourceComponents,sourceTransverse,sourceEnvelope,sampleSource,sampleTransmittedSource,stepSource,sourceProfile,maximumCoreSafeSeparation} from './source-packet-model.js?v=2.101';
import {detectorLaw,quantumSchedule,recordWithHit,samplePixel} from './packet-outcomes.js?v=2.101';
export function mountPacketEngine({core,advanced}){
 ...
 async function ensureSurface3D(){
  ...
  if(!surface3DLoad)surface3DLoad=import('./packet-surface-3d.js?v=2.101').then(({mountPacketSurface3D})=>{
