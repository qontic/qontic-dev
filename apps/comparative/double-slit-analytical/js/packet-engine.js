import {synthesize,sourceSchedule,stepParticles} from './spherical-field.js?v=43.1';
...
export function mountPacketEngine({core,advanced}) {
 ...
 function prepareSpherical(){
  ...
  sphericalPreparing=true;sphericalWorker=new Worker(new URL('./spherical-worker.js?v=43.1',import.meta.url),{type:'module'});
