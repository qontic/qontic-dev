...
import {mountPacketGeometry,trimTail,tailOpacity} from './packet-interaction.js?v=53';
...
export function mountPacketEngine({core,advanced}){
 ...
 function ensure(){const next=config();if(configFingerprint(next)!==fingerprint)resetEngine();else p.particles=next.particles;}
 function updateMath(){
